...
<body>
  ...
  ?>
  <form action="../lib/verify.php" method="post" id="login-form">

    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Team #</label>
      <div class="col-lg-10">
        <input type="text" name="username" class="form-control" id="inputEmail" placeholder="Team #" autocomplete="off" style="cursor: auto;">
      </div>
