...
<body>
    ...
    <form action="../lib/verify.php" method="post" style="width:50%;">
        ...
        <div class="col-lg-10 col-lg-offset-2">
            ...
            <small>Don't have an account? <a href="/account/create.php">Create one.</a></small>
			<small>Lost your password? <a href="http://www.blazerobotics.org/contact-us.html">Contact Us.</a></small>
        </div>
        <?php
        if (isset($_GET['err'])) {
            if ($_GET['err'] == "nomatch") {
